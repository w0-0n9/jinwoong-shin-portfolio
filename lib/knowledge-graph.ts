...
export const edges: GraphEdge[] = [
    ...
    { source: "jinwoong", target: "article-quantization-deep", relation: "wrote" },
    { source: "article-quantization-deep", target: "skill-on-prem-llm", relation: "covers" },
    { source: "article-quantization-deep", target: "skill-mlx", relation: "covers" },

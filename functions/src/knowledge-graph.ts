/**
 * Server-side mirror of `lib/knowledge-graph.ts` — same nodes + edges, no React imports.
 * Kept in sync manually. If you add a node/edge in lib, add it here too.
 */
...
export const nodes: GraphNode[] = [
    { id: "jinwoong", type: "person", label: "Jinwoong Shin", description: "LLM Engineer with 1.5+ years at LG CNS America. Ships enterprise GenAI across cloud and on-premises stacks. Incoming OMSCS at Georgia Tech, Fall 2026." },
    ...
    { id: "lg-cns", type: "company", label: "LG CNS America", description: "Current employer. Jinwoong joined June 2024 as an LLM Engineer building enterprise GenAI for LG Electronics.", meta: { period: "Jun 2024 – Present" } },
    { id: "samsung-sds", type: "company", label: "Samsung SDS", description: "Software Engineer Intern (Jun–Aug 2023). Built Salesforce CRM automations and AI-assisted features for Sales Cloud administrators.", meta: { period: "Jun 2023 – Aug 2023" } },
    { id: "nice-payments", type: "company", label: "NICE PAYMENTS", description: "Software Engineer Intern (Jan–Jun 2022). Built AR features for Hwahae beauty app using Unity, including AR Image Tracking and payment API integration.", meta: { period: "Jan 2022 – Jun 2022" } },

    { id: "georgia-tech", type: "school", label: "Georgia Tech", description: "Incoming · Fall 2026. M.S. in Computer Science (Online Master of Science in Computer Science, OMSCS), College of Computing.", meta: { status: "incoming", semester: "Fall 2026" } },
    { id: "uw-madison", type: "school", label: "UW–Madison", description: "B.S. in Computer Science, May 2024. GPA 3.55 / 4.00.", meta: { graduated: "May 2024", gpa: "3.55 / 4.00" } },

    { id: "doc-resume", type: "document", label: "Resume (PDF)", description: "Latest resume — Jinwoong Shin.", fileSrc: "/resume.pdf", fileTitle: "Resume — Jinwoong Shin", fileDownloadName: "Jinwoong_Shin_Resume.pdf" },
    { id: "doc-diploma", type: "document", label: "UW–Madison Diploma", description: "Bachelor of Science in Computer Science diploma from University of Wisconsin–Madison.", fileSrc: "/diploma.pdf", fileTitle: "Diploma — University of Wisconsin–Madison", fileDownloadName: "Jinwoong_Shin_Diploma.pdf" },
    { id: "doc-gt-admission", type: "document", label: "GT Offer of Admission", description: "Georgia Tech College of Computing — Offer of Admission for OMSCS, Fall 2026.", fileSrc: "/admission-offer.pdf", fileTitle: "Offer of Admission — Georgia Institute of Technology", fileDownloadName: "Jinwoong_Shin_GeorgiaTech_Admission.pdf" },

    { id: "proj-return-analysis", type: "project", label: "Return Reason Analysis AX", description: "End-to-end LLM-powered pipeline summarizing and classifying 230K+ annual return records across LG Electronics' Home Depot and LG.com (DTC) channels. ~2% return-rate reduction (~$1.6M annual savings, 2025 vs. 2024). On-premises migration to Gemma 4 on Apple Silicon with 91% accuracy parity to cloud baseline.", meta: { records: "230K+", savings: "~$1.6M", channels: "Home Depot, LG.com" } },
    { id: "proj-contact-center", type: "project", label: "Contact Center AX", description: "Enterprise contact center AI platform across 23 agents handling 800+ daily customer interactions (~11K monthly calls). Adaptive RAG (ReAct-based modular) multi-agent across Web, iMessage, WhatsApp. Knowledge ingestion: Bynder DAM → GCS → Salesforce Data Cloud (2,082 docs, 12.4GB), secured by Salesforce Trust Layer. Deployed in 2 months — 150% faster than industry baseline.", meta: { agents: "23", monthlyCalls: "~11K", docsIngested: "2,082" } },
    { id: "proj-olin-bike", type: "project", label: "Olin Cycling Experiences", description: "Personal project. Multi-language landing site + Stripe-backed booking flow for an exclusive Tour de France 2026 cycling experience. Live in production at olin.bike. Built solo with Next.js 14 (App Router + RSC), next-intl across EN/ES/FR/KO, Stripe Checkout + webhooks (live mode), deployed on Vercel Fluid Compute.", meta: { type: "personal", liveUrl: "https://www.olin.bike/", github: "https://github.com/w0-0n9/olin-bike" } },
    { id: "proj-salesforce-crm", type: "project", label: "Salesforce CRM Optimization", description: "At Samsung SDS. Salesforce CRM automations (Flow Builder for lead routing, opportunity stage transitions, approval flows) + custom Lightning Web Components backed by Apex + AI-assisted CRM prototype surfacing contextual customer insights inside record pages." },
    { id: "proj-hwahae-ar", type: "project", label: "Hwahae AR", description: "At NICE PAYMENTS. AR features for Hwahae beauty app: Unity-based image tracking to recognize cosmetic products, in-AR ingredient/review viewing, and payment API integration adapted from a Java-based system to Unity (C#)." },
    { id: "proj-portfolio-site", type: "project", label: "This Portfolio Site", description: "Personal project. Meta — the very site you're on right now. Next.js 16 (App Router + RSC, static export) with an Apple-inspired light design system, custom cursor, and Carousel/snap-scroll patterns throughout. Flagship feature: an Obsidian-style AI Assistant — a force-directed knowledge graph (react-force-graph-2d) wired to Vertex AI Gemini 2.5 Flash with structured JSON output. The model returns relevant graph node ids + document file ids that auto-render as inline PDF cards. Hosted on Firebase (Hosting + Cloud Functions).", meta: { type: "personal", liveUrl: "https://jinwoong-shin-portfolio.web.app", github: "https://github.com/w0-0n9/jinwoong-shin-portfolio" } },

    { id: "cert-aws-ai", type: "certification", label: "AWS Certified AI Practitioner", description: "Issued Feb 2026 by Amazon Web Services.", meta: { date: "Feb 2026" } },
    { id: "cert-palantir-foundry", type: "certification", label: "Foundry & AIP Builder Foundations", description: "Issued Dec 2025 by Palantir Technologies.", meta: { date: "Dec 2025" } },
    { id: "cert-palantir-speedrun", type: "certification", label: "Speedrun: Your First AIP Workflow", description: "Issued Dec 2025 by Palantir Technologies.", meta: { date: "Dec 2025" } },
